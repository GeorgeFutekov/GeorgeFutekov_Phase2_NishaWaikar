...
<body>
	<div class="container">
		...
		<p align="center">
			<span><strong> Displaying available flights from : <%=Search.source%>
					to : <%=Search.destination%> <br> 
					Date : <%=Search.date%> (<%=Search.day%>) <br> 
					No of people : <%=Search.persons%> <br>
		</p>
		<div align="center">
			<table class="table table-hover table-striped">
				...
				<tbody>
					<br>
					<p align="center">
						<span><strong>Select flight</strong></span>
					</p>
					<br>
					<%
						try {
